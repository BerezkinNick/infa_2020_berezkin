...
def ytka(scale):
    ...
    polygon(surface, (255, 211, 85), [(445, 615), (465, 620), (445, 625), (445, 640),
                                      (435, 630), (435, 640), (425, 620), (415, 630),
                                      (425, 610), (445, 615)])
    
    polygon(surface, (0, 0, 0), [(445, 615), (465, 620), (445, 625), (445, 640), (435, 630), (435, 640), (425, 620), (415, 630), (425, 610), (445, 615)], 1)
    
    # Заднее крыло:
    polygon(surface, (255, 255, 255), [(390, 460),
                                       (380, 420), (350, 390), (140, 340), (105, 330),
                                       (130, 360), (145, 370), (160, 380), (190, 390),
                                       (240, 405), (270, 420), (280, 480), (390, 460)])
    
    polygon(surface, (0, 0, 0), [(390, 460), (380, 420),(350, 390), (140, 340),(105, 330),
                                             (130, 360), (145, 370), (160, 380), (190, 390),
                                             (240, 405), (270, 420), (280, 480), (390, 460)], 1)
    # Тело:
    ...
    # Переднее крыло:
    polygon(surface, (255, 255, 255), [(380, 500), (370, 460), (340, 430), (130, 400), (95, 390), (120, 420), (135, 430),
                                       (150, 440), (180, 450), (230, 465), (260, 480), (270, 520), (380, 500)])
    polygon(surface, (0, 0, 0), [(380, 500), (370, 460), (340, 430), (130, 400), (95, 390), (120, 420),
                                 (135, 430), (150, 440), (180, 450), (230, 465), (260, 480), (270, 520), (380, 500)], 1)
...
#Вызов функций:
A=[1, 0.8] #масштаб рыбы
B=[0, 10, -30, -25] #угол поворота поверхности для чайки
C=[1, 0.5, 1, 0.8] #масштаб чайки
D=[0.4, 0.9] #масштаб утки
